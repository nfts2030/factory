...
import { TULUMCOIN_CONTRACT_ADDRESS, TOKEN_CONTRACT_ADDRESS } from "../const/addresses";

export default function UserProfile() {
    const address = useAddress();
    const {
        contract: monsterContract
    } = useContract(TULUMCOIN_CONTRACT_ADDRESS);
    const {
                        ...
                        >
                            <div className={styles.shopModal}>
                                ...
                                <div className={styles.claimButton}>
                                    <Web3Button
                                        contractAddress={TULUMCOIN_CONTRACT_ADDRESS}
